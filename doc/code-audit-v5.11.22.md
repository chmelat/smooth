...
| **Vyčistit při příležitosti** | ~~B1~~ (opraveno v5.11.24), ~~B2~~ (opraveno v5.11.25), ~~B3~~ (opraveno v5.11.26), ~~B4~~ (opraveno v5.11.27 + v5.11.28), ~~B5~~ (opraveno v5.11.30), ~~B6~~ (opraveno v5.11.31), ~~B13~~ (atoi → strtod, opraveno v5.11.54), B14 (rozšířit butterworth konvenci jinde) |
