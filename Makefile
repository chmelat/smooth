...
# Files
SRC = smooth.c tikhonov.c polyfit.c savgol.c butterworth.c grid_analysis.c timestamp.c parser.c
OBJ = $(SRC:.c=.o)
HEAD = revision.h tikhonov.h polyfit.h savgol.h butterworth.h grid_analysis.h timestamp.h parser.h
